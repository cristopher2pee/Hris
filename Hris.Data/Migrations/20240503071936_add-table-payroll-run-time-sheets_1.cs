...
{
    /// <inheritdoc />
    public partial class addtablepayrollruntimesheets_1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PayrollRunTimeSheets",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayrollRunTimeSheets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PayrollRunTimeSheets_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PayrollRunTimeSheets_PayrollRun_PayrollRunId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollRunTimeSheets_EmployeeId",
                table: "PayrollRunTimeSheets",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_PayrollRunTimeSheets_PayrollRunId",
                table: "PayrollRunTimeSheets",
                column: "PayrollRunId");
        }

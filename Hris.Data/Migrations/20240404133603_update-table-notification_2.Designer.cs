...
namespace Hris.Data.Migrations
{
    ...
    [Migration("20240404133603_update-table-notification_2")]
    partial class updatetablenotification_2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hris.Data.Models.Administrator.Access", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4a6caed1-4bb4-405d-9484-72c6ff979b52"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9215),
                            ModifiedBy = new Guid("6378b433-5cd3-4dd7-8c54-236320c1bc19"),
                            Module = "Employees",
                            Name = "Employee",
                            Path = "Employee",
                            Roles = "Admin,Hr"
                        ...
                        new
                        {
                            Id = new Guid("ad0ed264-9fb0-4fce-9eef-86047b6173bf"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9219),
                            ModifiedBy = new Guid("c45db291-a7be-485f-b043-82e013612fc1"),
                            Module = "Employees",
                            Name = "Department",
                            Path = "Department",
                            Roles = "Admin,Manager"
                        ...
                        new
                        {
                            Id = new Guid("1ca424ff-195b-4a64-ba5e-5bcc119a3bde"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9220),
                            ModifiedBy = new Guid("e5d4ff2c-4660-4372-825a-c273db285c14"),
                            Module = "Employees",
                            Name = "Position",
                            Path = "Position",
                            Roles = "Admin,Manager"
                        ...
                        new
                        {
                            Id = new Guid("87a6efa2-e8b1-446e-81a0-bf9582b454b4"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9222),
                            ModifiedBy = new Guid("cb34fa30-2c8d-472e-a5f9-1627be34ba60"),
                            Module = "Employees",
                        ...
                        new
                        {
                            Id = new Guid("2d507a40-4d60-44d3-9df4-1e452b639c66"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9241),
                            ModifiedBy = new Guid("a06c2bcf-0404-4e24-a321-fd1427ce989c"),
                            Module = "Employees",
                        ...
                        new
                        {
                            Id = new Guid("37710c14-e547-4a6d-b1cb-222735cadaad"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9242),
                            ModifiedBy = new Guid("0bc43251-5d6d-4bc5-a4c4-a2b04186c6d0"),
                            Module = "Clock",
                            Name = "Project",
                            Path = "Project",
                            Roles = "Admin,Manager"
                        ...
                        new
                        {
                            Id = new Guid("2fa5c425-94fb-4e57-9cf2-6804f24fc813"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9244),
                            ModifiedBy = new Guid("601ff470-b107-4b33-ac6b-457b1f3eb990"),
                            Module = "Clock",
                            Name = "Clients",
                            Path = "Clients",
                            Roles = "Admin,Manager"
                        ...
                        new
                        {
                            Id = new Guid("46ed4c9a-38ed-42fb-a399-c684e1cecca2"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9245),
                            ModifiedBy = new Guid("d4e5812d-0444-4bef-ab54-6340b8128248"),
                            Module = "Clock",
                            Name = "Track",
                            Path = "Track",
                        ...
                        new
                        {
                            Id = new Guid("3dcba80b-462b-40bb-9419-89693dcf4351"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9248),
                            ModifiedBy = new Guid("bd719e16-b9e2-4163-bccf-0c9d848bb478"),
                            Module = "Clock",
                            Name = "ChangeRequest",
                            Path = "ChangeRequest",
                            Roles = "Admin,Manager"
                        ...
                        new
                        {
                            Id = new Guid("6df9b320-7652-4ddc-a28b-91325b74cdc5"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9250),
                            ModifiedBy = new Guid("3167eef1-cc05-4ccb-ad62-6df2d1e6a6eb"),
                            Module = "Clock",
                            Name = "AssignProject",
                            Path = "AssignProject",
                            Roles = "Admin,Manager"
                        ...
                        new
                        {
                            Id = new Guid("a4b8a121-1390-4172-92e1-85251679aba0"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9251),
                            ModifiedBy = new Guid("c0581820-ec74-463e-89bd-535929e341c1"),
                            Module = "Clock",
                            Name = "Reports",
                            Path = "Reports",
                            Roles = "Admin,Manager"
                        ...
                        new
                        {
                            Id = new Guid("465cd6cd-e24c-4511-a5e8-50562445fd96"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9252),
                            ModifiedBy = new Guid("9ddacf12-9f19-4ed2-b003-48a5cef7f410"),
                            Module = "Payroll",
                            Name = "AllowanceType",
                            Path = "AllowanceType",
                            Roles = "Admin,Hr"
                        ...
                        new
                        {
                            Id = new Guid("18184b5e-997c-42de-8970-e7ec7efcc14c"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9256),
                            ModifiedBy = new Guid("68955bc5-f275-4048-8fba-a0e6047b4ed1"),
                            Module = "Payroll",
                            Name = "Entitlements",
                            Path = "Entitlements",
                            Roles = "Admin,Hr"
                        ...
                        new
                        {
                            Id = new Guid("a6f724b3-1082-48ce-8cd8-2ef84a2ef471"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9257),
                            ModifiedBy = new Guid("66756dfd-e94d-4b1b-b4a6-0da65f7ee977"),
                            Module = "Payroll",
                            Name = "Deduction Type",
                            Path = "Deduction-Type",
                            Roles = "Admin,Hr"
                        ...
                        new
                        {
                            Id = new Guid("6f2f8ef2-1000-423f-b073-ff4396ee57a5"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9258),
                            ModifiedBy = new Guid("371d98ce-9c16-4e8f-b08f-eae6c607fb3b"),
                            Module = "Payroll",
                        ...
                        new
                        {
                            Id = new Guid("d25e8f9b-9e99-4c7a-a42a-66fe44289322"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9260),
                            ModifiedBy = new Guid("de94e030-b177-471a-9cba-ad326afcc540"),
                            Module = "Admin",
                            Name = "Invite",
                            Path = "Invite",
                            Roles = "Admin,Manager,Hr"
                        ...
                        new
                        {
                            Id = new Guid("5763d365-446e-40e6-a880-7b1c9357fd76"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9262),
                            ModifiedBy = new Guid("5b0615f5-4877-428b-8de7-3f6c9a859cf7"),
                            Module = "Admin",
                            Name = "Access",
                            Path = "Access",
                            Roles = "Admin,Manager"
                        ...
                        new
                        {
                            Id = new Guid("4e942bc8-5762-4867-8177-ef47ad5e6753"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9265),
                            ModifiedBy = new Guid("4f373a38-34e8-423d-b4cd-f6082c6b335f"),
                            Module = "Admin",
                            Name = "Calendar",
                            Path = "Calendar",
                            Roles = "Admin,Manager,Hr"
                        ...
                        new
                        {
                            Id = new Guid("862e553a-8003-4d7a-a85f-7cf207008326"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9266),
                            ModifiedBy = new Guid("a06f3599-84b9-409d-932d-47fae9100b20"),
                            Module = "Admin",
                            Name = "Permission",
                            Path = "Permission",
                            Roles = "Admin,Manager"
                        ...
                        new
                        {
                            Id = new Guid("02b32613-7012-4bee-8020-58d4e01104d7"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9268),
                            ModifiedBy = new Guid("7974a752-0637-4a17-b321-491a80384d57"),
                            Module = "Leave",
                            Name = "LeaveType",
                            Path = "Leave-Types",
                            Roles = "Admin,Manager,Hr"
                        ...
                        new
                        {
                            Id = new Guid("69546cef-c08a-4af0-a68c-3b0bcc4fa9cc"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9271),
                            ModifiedBy = new Guid("3ce8669d-58f6-4da7-81ef-affc2e238da9"),
                            Module = "Leave",
                        ...
                        new
                        {
                            Id = new Guid("c5710e69-8c8e-4ac3-b633-f59a7da3f4ee"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9272),
                            ModifiedBy = new Guid("a7ecb2a1-e730-4915-aab2-822d65d8de16"),
                            Module = "Leave",
                        ...
                        new
                        {
                            Id = new Guid("c0da9145-c97c-4018-8406-ce1693730a38"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9274),
                            ModifiedBy = new Guid("c9852247-9524-4954-8ae8-aa32d71a65eb"),
                            Module = "Leave",
                            Name = "LeaveRequest",
                            Path = "Leave-Request",
                        ...
                        new
                        {
                            Id = new Guid("db396cd5-5e74-4f6a-a4a0-b6f1843a22c4"),
                            Active = true,
                            Modified = new DateTime(2024, 4, 4, 13, 36, 2, 819, DateTimeKind.Utc).AddTicks(9276),
                            ModifiedBy = new Guid("63112c0d-7c05-4c7d-b131-83ed292fd7ba"),
                            Module = "Employees",
